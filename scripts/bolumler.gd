...
const BOLUMLER: Array[Dictionary] = [
	...
	{
		"ad": "9 — Salıncak",
		"ipucu": "Kesik çizgili kutuda çevirme yasak. Kutuya girmeden karar ver.",
		"altin": 6.2,
		"gumus": 9.0,
		"bronz": 13.0,
		"cevirme": 4,
	...
	{
		"ad": "14 — Boşluk Üstü",
		"ipucu": "Oklu platform yalnız ok yönünden geçilir; öbür yandan gelince tutar.",
		"altin": 11.5,
		"gumus": 16.7,
		"bronz": 24.2,
		"cevirme": 6,
